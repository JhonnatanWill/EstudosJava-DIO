...
/*
Desafio
Vamos exercitar todo o conteúdo apresentado no módulo de Sintaxe codificando 
o seguinte cenário.
...
Dentro do projeto, crie a classe ContaTerminal.java para realizar toda 
...
Obter pela classe scanner os valover digitados no  terminal
